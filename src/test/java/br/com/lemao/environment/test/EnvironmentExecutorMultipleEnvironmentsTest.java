...
import br.com.lemao.environment.environments.multiple.TwoBikersWithBicyclesWithFatherGivenEnvironmentsEnvironment;
...
public class EnvironmentExecutorMultipleEnvironmentsTest {
	...
	@Test
    public void twoBikersWithBicyclesCreatedByEnvironmentAgregateWithFatherGivenEnvironmets() {
        EnvironmentExecutor.gimme().execute(TwoBikersWithBicyclesWithFatherGivenEnvironmentsEnvironment.class);
