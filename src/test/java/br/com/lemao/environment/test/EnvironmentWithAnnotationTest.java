...
import br.com.lemao.environment.environments.annotation.BikerEnvironmentWithAnnotation;
import br.com.lemao.environment.environments.annotation.OneMaleBikerAndOneBicycleForThisBikerWithAnnotation;
import br.com.lemao.environment.environments.annotation.TwoBikersOneMaleAnotherFemaleAndOneBicycleForMaleBikerWithAnnotation;
...
public class EnvironmentWithAnnotationTest {
	...
	public void oneBikerAndOneBicycleForThisBikerCreatedByEnvironment() {
		EnvironmentExecutor.gimme().execute(OneMaleBikerAndOneBicycleForThisBikerWithAnnotation.class);
	...
	public void twoBikersOneMaleAnotherFemaleAndOneBicycleForMaleBikerCreatedByEnvironment() {
		EnvironmentExecutor.gimme().execute(TwoBikersOneMaleAnotherFemaleAndOneBicycleForMaleBikerWithAnnotation.class);
	...
	public void twoBikersOneMaleAnotherFemaleCreatedByEnvironment() {
		EnvironmentExecutor.gimme().execute(BikerEnvironmentWithAnnotation.class, "twoBikersOneMaleAnotherFemale");
	...
	public void twoBikersOneMaleAnotherFemaleWithBicyclesCreatedByEnvironment() {
		EnvironmentExecutor.gimme().execute(BikerEnvironmentWithAnnotation.class, "twoBikersOneMaleAnotherFemaleWithBicycles");
